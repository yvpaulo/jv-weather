...
import { UnitSelectorComponent } from  './unit-selector/unit-selector.component' //'../unit-selector/unit-selector.component';
import { Units } from 'src/app/shared/models/units.enum';
import * as fromHomeActions from   './../state/home.actions';//'../../state/home.actions';
import * as fromHomeSelectors from './../state/home.selectors';//'../../state/home.selectors';
import * as fromBookmarksSelectors from './../../bookmarks/state/bookmarks.selectors';//'../../../bookmarks/state/bookmarks.selectors';
...
import * as fromHomeSelectores from '../state/home.selectors';
...
export class HomePage implements OnInit, OnDestroy {
  ...
  ngOnInit(){
   ...
   this.store.pipe(select(fromHomeSelectores.selectCurrentWeather))
   .subscribe(value => this.cityWeather = value);
   this.loading$ = this.store.pipe(select(fromHomeSelectores.selectCurrentWeatherLoading));
   this.error$ = this.store.pipe(select(fromHomeSelectores.selectCurrentWeatherError));
